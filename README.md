...
- `use_congruence_of_squares` (default value: `True`): This attempts to check congruence of squares. (This mode will ultimately become Gaussian elimination, with future development.)
