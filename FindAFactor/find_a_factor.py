...
def find_a_factor(n,
    ...
    return int(_find_a_factor._find_a_factor(str(n), use_congruence_of_squares, node_count, node_id, gear_factorization_level, wheel_factorization_level, thread_count, smoothness_bound_multiplier))